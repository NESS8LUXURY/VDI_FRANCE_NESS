...
lyr_VDINESSLUXURY_1.set('fieldAliases', {'id': 'id', 'Nom': 'Nom', 'PRENOM_f': 'PRENOM_f', 'FACEBOOK A': 'FACEBOOK A', });
lyr_VDINESSLUXURY_1.set('fieldImages', {'id': 'TextEdit', 'Nom': 'TextEdit', 'PRENOM_f': 'TextEdit', 'FACEBOOK A': 'TextEdit', });
lyr_VDINESSLUXURY_1.set('fieldLabels', {'id': 'inline label - always visible', 'Nom': 'inline label - always visible', 'PRENOM_f': 'inline label - always visible', 'FACEBOOK A': 'inline label - always visible', });
